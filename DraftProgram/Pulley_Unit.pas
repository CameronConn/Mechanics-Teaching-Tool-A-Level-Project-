...
Var Ball2Size,Ball1XAway,Ball1YAway,LineY,LineX : real;
begin
  ...
  Particles[1].Position.X := 235;
  Particles[1].Position.Y := 575;
  ...
  LineY:=594 - (Plank_Size * Sin(DegToRad(45)));
  LineX:= 269+ (Plank_Size * Cos(DegToRad(45)));
  Ball2_Line.Stroke.Thickness:=2;
  Ball2_Line.RotationCenter.X:=0;
  Ball2_Line.RotationCenter.Y:=0;
  Ball2_Line.RotationAngle:=90;
  Ball2_Line.Position.X:=LineX;
  Ball2_Line.Position.Y:=LineY;
  ...
  Ball1_Line.Position.X:=LineX;
  Ball1_Line.Position.Y:=LineY;
  Ball1_Line.Height:=50;
  Ball1YAway:=(Particles[1].Position.Y)-(Ball1_Line.Position.Y);
  Ball1XAway:=(Ball1_Line.Position.X)- (Particles[1].Position.X);
  Ball1_Line.Width:=Sqrt((Power(Ball1YAway,2))+(Power(Ball1XAway,2)));
end;



procedure TPulley_Form.UpdateClick(Sender: TObject);
Var  Ball1XAway,Ball1YAway,Ball1Width,Ball2Width,NewLineX,NewLineY,Plank_Angle,C_Of_Friction,Ball1_Mass,Ball2_Mass,Length_Plank,Length_String,Distance_Up_Plank : real;
begin
  ...
  NewLineY:=594 - (Plank_Size * Sin(DegToRad(Plank_Angle)));
  NewLineX:= 269+ (Plank_Size * Cos(DegToRad(Plank_Angle)));
  Ball1YAway:=(Particles[1].Position.Y)-(Ball1_Line.Position.Y);         //need to use new ball position.
  Ball1XAway:=(Ball1_Line.Position.X)- (Particles[1].Position.X);
  Ball1Width:=Sqrt((Power(Ball1YAway,2))+(Power(Ball1XAway,2)));
  Ball2Width:=(Particles[2].Position.Y - Ball2_Line.Position.Y) + 20;
  Ball1_Line.AnimateFloat('rotationangle',(180-Plank_Angle),1);
  Ball1_Line.AnimateFloat('width',Ball1Width,1);
  Ball2_Line.AnimateFloat('width',Ball2Width,1);
  Ball1_Line.AnimateFloat('position.y',NewLineY,1);
  Ball1_Line.AnimateFloat('position.x',NewLineX,1);
  Ball2_Line.AnimateFloat('position.y',NewLineY,1);
  Ball2_Line.AnimateFloat('position.x',NewLineX,1);
  Particles[1].Moveballs(Distance_Up_Plank,Length_Plank,Plank_Angle,Length_String);
end;
